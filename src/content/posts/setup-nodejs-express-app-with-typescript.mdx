...
1. **start** command
    - **`"start"`**: This is the name of the npm script. When you run **pnpm run start** in the terminal, it executes the command associated with this script.
...
2. **dev** command
    - **`"dev"`**: This is the name of the npm script. When you run **pnpm run dev** in the terminal, it executes the command associated with this script.
...
3. **build** command
        - **`"build"`**: This is the name of the npm script. When you run **pnpm run build** in the terminal, it executes the command associated with this script.
