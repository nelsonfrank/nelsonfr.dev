            ...
            <Image src="/hero_coding_illustration.svg" height={500} width={500} />
                <div className='md:nf-px-8 nf-flex nf-flex-col md:nf-items-center nf-flex-1'>
                    <div className='nf-text-center md:nf-mt-20'>
                        ...
                        <h2 className='nf-font-semibold nf-text-3xl lg:nf-text-5xl nf-animate-typing'>A Fullstack Web Developer</h2>

                        <p className='nf-my-4'>I love using latest technology to solve this era challenges.</p>
                        <div className='nf-flex nf-justify-center nf-my-6'>
                            <button className='nf-text-white nf-bg-primary nf-py-3 nf-px-6 nf-rounded-xl'>Get in touch</button>
                        </div>
                    </div>
                </div>
            </section>
